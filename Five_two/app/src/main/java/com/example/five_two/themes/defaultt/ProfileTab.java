...
import com.example.five_two.pages.MainPage;
import com.example.five_two.pages.MyFriendsPage;
import com.example.five_two.pages.SettingsPage;
import com.example.five_two.pages.dialog.ErrorDialog;
import com.example.five_two.pages.dialog.ProgressDialog;
import com.example.five_two.tabs.Tab;
import com.example.five_two.themes.defaultt.components.HeaderFooterProvider;
import com.example.five_two.themes.defaultt.components.ScrollableRelativeLayout;
import com.example.five_two.themes.defaultt.components.UserBriefView;
...
public class ProfileTab implements Tab {
	...
	private void getLoginUser(final Context context, final boolean showPd) {
	...
	private void goLogin(final Context context, final boolean showPd) {
	...
	public void onSelected() {
		if (page.getUser() != null) {
			...
			if (!TextUtils.isEmpty(UMSSDK.getLoginUserToken())) {
				getLoginUser(page.getContext(), true);
			}
		}
	}
	...
	private static class ProfileAdapter extends PullToRequestAdatper {
		...
		public ProfileAdapter(ProfileTab tab, PullToRequestView view) {
			...
			bodyView.addView(llPage, new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT));
		}
