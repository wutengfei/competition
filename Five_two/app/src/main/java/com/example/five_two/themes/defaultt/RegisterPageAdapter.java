...
import com.example.five_two.pages.PostRegisterPage;
import com.example.five_two.pages.RegisterPage;
import com.example.five_two.pages.dialog.ErrorDialog;
import com.example.five_two.pages.dialog.OKDialog;
...
import com.example.five_two.themes.defaultt.components.VCodeView;
...
public class RegisterPageAdapter extends DefaultThemePageAdapter<RegisterPage> {
	...
	private boolean check(String phone, String vcode, String password){
		...
		if (TextUtils.isEmpty(vcode) || vcode.length() <= 0) {
			Toast.makeText(getPage().getContext(), ResHelper.getStringRes(getPage().getContext(),
...
//				t.printStackTrace();
	...
	@Override
	public void onDestroy(RegisterPage page, Activity activity) {
