...
public class MyAdapter_Cinema extends BaseAdapter {
    private Context mContext;
    private List<String> mList = new ArrayList<>();

    public MyAdapter_Cinema(Context context, List<String> list) {
        mContext = context;
        mList = list;
    }
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            view = LayoutInflater.from(mContext).inflate(R.layout.cinema_item_listview, null);
            viewHolder.mTextView = (TextView) view.findViewById(R.id.moviename);
            viewHolder.mButton = (Button) view.findViewById(R.id.cinemabtnbuy);
