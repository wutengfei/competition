...
public class MyAdapter_Cinema_in extends BaseAdapter {
    private Context mContext;
    private List<String> mList = new ArrayList<>();

    public MyAdapter_Cinema_in(Context context, List<String> list) {
        mContext = context;
        mList = list;
    }
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            view = LayoutInflater.from(mContext).inflate(R.layout.cinema_in_listview, null);
            viewHolder.mTextView = (TextView) view.findViewById(R.id.cinemainmoviename);
            viewHolder.mButton = (Button) view.findViewById(R.id.cinemainbuy);
