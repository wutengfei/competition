...
public class MyAdapter_Movie_in extends BaseAdapter {
    private Context mContext;
    private List<String> mList = new ArrayList<>();

    public MyAdapter_Movie_in(Context context, List<String> list) {
        mContext = context;
        mList = list;
    }
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            view = LayoutInflater.from(mContext).inflate(R.layout.movie_in_listview, null);
            viewHolder.mTextView = (TextView) view.findViewById(R.id.movieincinemaname);
            viewHolder.mButton = (Button) view.findViewById(R.id.movieinbtnbuy);
